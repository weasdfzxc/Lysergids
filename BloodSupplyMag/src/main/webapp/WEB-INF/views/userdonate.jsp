...
<body>
	...
	<div class="container-fluid">
		...
		<ul class="nav navbar-nav">
			...
			<li class="active"><a href="${contextPath}/user/donate.htm">Donate</a></li>
	...
	<div class="content container">
		...
		<form class="row content form-horizontal" method="post"
			action="${contextPath}/user/donate.htm">
			<h2 class='text-center'>
			...
			<div class="col-lg-offset-3 col-lg-6  row">
				...
				<div class="col-lg-offset-1 col-lg-10">
					<div class="form-group">
						<label for="donations">donations(ml):</label> <input type="number"
							class="form-control" id="donations" name="donations" min="200" max="600">
					</div>
				</div>
				<br /> <br /> <br /> <br />
